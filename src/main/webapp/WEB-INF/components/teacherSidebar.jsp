...
<aside class="app-sidebar d-none d-md-flex flex-column position-fixed top-0 start-0 py-4 px-3">
    ...
    <nav class="flex-grow-1 d-flex flex-column gap-2">
        ...
        <a href="<c:url value='/TeacherClassroom'/>" class="sidebar-nav-link ${activeSidebar eq 'resources' ? 'active' : ''} d-flex align-items-center gap-3 px-3 py-2 text-decoration-none">
