...
<head>
    ...
    <title>EduStand - Forgot Password</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <main class="container-fluid max-w-5xl p-0">
        <div class="row g-0 main-panel card-sleek bg-surface-container-lowest min-vh-60 min-vh-md-75">
            ...
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center p-4 py-5 p-md-5 p-lg-5">
                    ...
                    <div class="vstack gap-3">
                        <div class="input-group input-group-float">
                            ...
                            <div class="form-floating flex-grow-1">
                                <input type="email" id="recoveryEmail" class="form-control input-with-addon" placeholder="Email ID" required autofocus>
                                <label for="recoveryEmail">Email ID</label>
                            </div>
                        </div>
                ...
                <!-- OTP Phase (Hidden initially) -->
                <div id="otpPhase" class="d-none">
                    <div class="card-sleek otp-static-card p-3 p-md-4 mb-3">
                        <div class="small text-on-surface-variant mb-3">Enter the 6-digit code</div>
                        <div class="d-flex justify-content-between gap-2 otp-input-row">
                            <input type="text" class="form-control otp-digit" maxlength="1" inputmode="numeric" aria-label="OTP digit 1">
                            <input type="text" class="form-control otp-digit" maxlength="1" inputmode="numeric" aria-label="OTP digit 2">
                            <input type="text" class="form-control otp-digit" maxlength="1" inputmode="numeric" aria-label="OTP digit 3">
                            <input type="text" class="form-control otp-digit" maxlength="1" inputmode="numeric" aria-label="OTP digit 4">
                            <input type="text" class="form-control otp-digit" maxlength="1" inputmode="numeric" aria-label="OTP digit 5">
                            <input type="text" class="form-control otp-digit" maxlength="1" inputmode="numeric" aria-label="OTP digit 6">
                        </div>
                    </div>
                ...
                <p class="mt-4 text-center small text-on-surface-variant mb-0">
                    Need help? <a href="<c:url value='/request-access'/>" class="fw-semibold text-primary-link">Contact support</a>
                </p>
            </div>
