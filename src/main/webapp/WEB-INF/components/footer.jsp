<footer class="dashboard-footer d-flex flex-column flex-sm-row justify-content-between align-items-center px-4 py-4 mt-auto">
    <p class="m-0 small fw-semibold text-on-surface-variant" style="font-size: 12px;">&copy; 2026 EduStand | Created with <i class="fa-regular fa-heart"></i> by nepalsolutionhub</p>
