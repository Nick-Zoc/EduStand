...
<aside class="app-sidebar d-none d-md-flex flex-column position-fixed top-0 start-0 py-4 px-3">
    <div class="d-flex align-items-center gap-3 mb-5 px-2 sidebar-brand-copy">
        ...
        <div>
            ...
            <p class="small fw-bold sidebar-subtitle m-0">RESOURCE PORTAL</p>
        </div>
    </div>

    <nav class="flex-grow-1 d-flex flex-column gap-2">
        <a href="<c:url value='/TeacherDashboard'/>" class="sidebar-nav-link ${activeSidebar eq 'dashboard' ? 'active' : ''} d-flex align-items-center gap-3 px-3 py-2 text-decoration-none">
            <i class="fa-solid fa-chart-line fs-6 sidebar-icon"></i>
            <span class="brand-headline small sidebar-label">Dashboard</span>
        </a>
        <a href="#" class="sidebar-nav-link ${activeSidebar eq 'curriculum' ? 'active' : ''} d-flex align-items-center gap-3 px-3 py-2 text-decoration-none">
            <i class="fa-solid fa-book-open fs-6 sidebar-icon"></i>
            <span class="brand-headline small sidebar-label">Curriculum</span>
        </a>
        <a href="#" class="sidebar-nav-link ${activeSidebar eq 'resources' ? 'active' : ''} d-flex align-items-center gap-3 px-3 py-2 text-decoration-none">
            <i class="fa-solid fa-folder-tree fs-6 sidebar-icon"></i>
            <span class="brand-headline small sidebar-label">Resources</span>
        </a>
        <a href="#" class="sidebar-nav-link ${activeSidebar eq 'analytics' ? 'active' : ''} d-flex align-items-center gap-3 px-3 py-2 text-decoration-none">
            <i class="fa-solid fa-chart-pie fs-6 sidebar-icon"></i>
            <span class="brand-headline small sidebar-label">Analytics</span>
        </a>
    </nav>
