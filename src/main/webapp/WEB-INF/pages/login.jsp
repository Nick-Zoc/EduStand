            ...
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center p-4 py-5 p-md-5 p-lg-5">
                ...
                <form action="${pageContext.request.contextPath}/login" method="post" class="vstack gap-3">
                    ...
                    <div class="input-group input-group-float">
                        ...
                        <div class="form-floating flex-grow-1">
                            <input type="password" class="form-control input-with-addon" id="password" name="password" placeholder="Password" required>
                    ...
                    <button type="submit" class="btn btn-primary btn-primary-edu w-100 py-2 mt-2 fw-semibold">Login</button>

                    <div class="text-center mt-1">
                        <a href="<c:url value='/forgot-password'/>" class="small fw-semibold text-primary-link forgot-link-inline">Forgot Password?</a>
                    </div>
                </form>
