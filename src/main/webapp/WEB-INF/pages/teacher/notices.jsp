...
<head>
    ...
    <title>EduStand | My Notices</title>
    <meta name="description" content="Manage your posted notices on EduStand.">
...
<body class="dashboard-shell bg-surface text-on-surface">
        ...
        <div class="px-3 px-md-4 py-3 w-100 users-flat-shell">
            ...
            <div class="users-page-intro d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-3 mb-3">
                <div>
                    ...
                    <h2 class="users-title fs-1 fw-bold m-0 brand-headline text-on-surface">My Notices</h2>
                    <p class="users-subtitle text-on-surface-variant mb-0" style="max-width:46rem;line-height:1.6;">
                        Create and manage your posted notices. They appear on all student and teacher dashboards while active.
                    </p>
                </div>
                <div>
                    ...
                    <table class="table table-hover align-middle mb-0 table-index users-flat-table">
                        <thead class="bg-surface">
                            <tr>
                                ...
                                <th class="px-3 py-3 fw-bold small text-uppercase text-on-surface-variant" style="letter-spacing:.04em;">POSTED</th>
                        ...
                        <tbody id="noticesTableBody">
                            <tr><td colspan="6" class="text-center py-5 text-on-surface-variant">
    ...
    async function loadNotices() {
        try {
            ...
            document.getElementById('noticesTableBody').innerHTML = '<tr><td colspan="6" class="text-center py-5 text-danger">Failed to load notices.</td></tr>';
        }
    }
    ...
    function renderTable(notices) {
        ...
        if (!notices.length) {
            tbody.innerHTML = '<tr><td colspan="6" class="text-center py-5 text-on-surface-variant">No notices found. Post one above!</td></tr>';
            return;
        }
